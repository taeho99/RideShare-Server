...
|`400`|`확정되거나 종료된 파티`|이미 확정되거나 종료된 파티를 참여하는 경우|
...
|------|---|---|
|`401`|`Access Token이 만료되었습니다.`|사용자의 Access Token이 만료되었거나 유효하지 않은 경우|
|`400`|`기존 비밀번호가 일치하지 않습니다.`|기존 비밀번호가 잘못 입력된 경우|
|`400`|`새로운 비밀번호가 기존 비밀번호와 일치합니다.`|새로운 비밀번호와 기존 비밀번호가 일치한 경우|
